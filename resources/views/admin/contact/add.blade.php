    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Add New Contact <small>different form elements</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        @endif
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="admin/contact/add" method="POST">
